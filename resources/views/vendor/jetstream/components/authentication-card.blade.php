<div class="min-h-screen flex flex-row sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
    <div>
        <!-- <img src="logo.jpg" alt="logo" class="xl:w-40 xl:h-80 md:w-30 md:h-64 w-21 h-80 mr-12"> -->
        <img src="logo.jpg" alt="logo" class="xl:w-80 xl:h-80 md:h-64 md:w-64 w-15 h-0 mr-12">
    </div>
